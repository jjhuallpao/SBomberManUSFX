...
MenuScene::MenuScene(GameManager* _gameManager) : Scene(_gameManager)
{
    ...
    background->setSize(gameManager->getWindowWidth() - 60,  static_cast<int>(gameManager->getWindowHeight() / 1.5f) - 30);
   ...
   /* startText = std::make_shared<Text>(gameManager->getAssetManager()->getFont(), gameManager->getRenderer(), "INICIO");
    ...
    startCartoonText->setSize(static_cast<int>(gameManager->getWindowWidth() / 4.0f), static_cast<int>(gameManager->getWindowHeight() / 25.0f));
    ...
    startClasicText->setSize(static_cast<int>(gameManager->getWindowWidth() / 4.0f), static_cast<int>(gameManager->getWindowHeight() / 25.0f));
    ...
    startCustomText->setSize(static_cast<int>(gameManager->getWindowWidth() / 4.0f), static_cast<int>(gameManager->getWindowHeight() / 25.0f));
    ...
    startRealisticText->setSize(static_cast<int>(gameManager->getWindowWidth() / 6.8f), static_cast<int>(gameManager->getWindowHeight() / 25.0f));
    startRealisticText->setPosition(static_cast<int>(gameManager->getWindowWidth() / 2.0f - startCustomText->getWidth() / 2.0f), background->getHeight() + 155);
    ...
    exitText->setSize(static_cast<int>(gameManager->getWindowWidth() / 6.0f), static_cast<int>(gameManager->getWindowHeight() / 25.0f));
    exitText->setPosition(startCartoonText->getPositionX(), startCustomText->getPositionY() + exitText->getHeight() + 45);
    addObject(exitText);
